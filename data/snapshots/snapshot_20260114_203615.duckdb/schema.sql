CREATE TABLE chat_artifacts(session_id VARCHAR, message_id VARCHAR, artifact_type VARCHAR, artifact_data JSON NOT NULL, created_at TIMESTAMP DEFAULT(CURRENT_TIMESTAMP), PRIMARY KEY(session_id, message_id, artifact_type));;
